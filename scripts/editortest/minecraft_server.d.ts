...
export class Block {
     ...
     * @throws This function can throw errors.
     */
    getComponent<T extends keyof BlockComponentRoute>(componentName: T): BlockComponentRoute[T];
     ...
     * ```
     */
    hasTag(tag: "wood" | "pumpkin" | "plant" | "stone" | "metal" | "diamond_pick_diggable" | "gold_pick_diggable" | "iron_pick_diggable" | "stone_pick_diggable" | "wood_pick_diggable" | "dirt" | "sand" | "gravel" | "grass" | "snow" | "rail" | "water" | "mob_spawner" | "lush_plants_replaceable" | "azalea_log_replaceable" | "not_feature_replaceable" | "text_sign" | "minecraft" | "fertilize_area" | "acacia" | "birch" | "dark_oak" | "jungle" | "log" | "oak" | "spruce"): boolean;
    isAir(): boolean;
    isLiquid(): boolean;
    isSolid(): boolean;
    /**
...
export class BlockPermutation {
     ...
     * permutation has.
     */
    getAllProperties(): BlockPropertiesRoute;
     ...
     */
    getProperty<R extends keyof BlockPropertiesRoute>(propertyName: R): BlockPropertiesRoute[R];
    /**
     * @beta
     * @remarks
     ...
     */
    hasTag(tag: "wood" | "pumpkin" | "plant" | "stone" | "metal" | "diamond_pick_diggable" | "gold_pick_diggable" | "iron_pick_diggable" | "stone_pick_diggable" | "wood_pick_diggable" | "dirt" | "sand" | "gravel" | "grass" | "snow" | "rail" | "water" | "mob_spawner" | "lush_plants_replaceable" | "azalea_log_replaceable" | "not_feature_replaceable" | "text_sign" | "minecraft" | "fertilize_area" | "acacia" | "birch" | "dark_oak" | "jungle" | "log" | "oak" | "spruce"): boolean;
    matches(blockName: string, properties?: BlockPropertiesRoute): boolean;
    withProperty<R extends keyof BlockPropertiesRoute>(name: R, value: BlockPropertiesRoute[R]): BlockPermutation;
    static resolve(blockName: string, properties?: BlockPropertiesRoute): BlockPermutation;
}
/**
 * @beta
...
export class Entity {
     ...
     */
    getComponent<T extends keyof EntityComponentRoute>(componentId: T): EntityComponentRoute[T];
    /**
     * @beta
     * @remarks
...
export class ItemStack {
     ...
     * ```
     */
    getComponent<T extends keyof ItemComponentRoute>(componentId: T): ItemComponentRoute[T];
    /**
     * @remarks
...
export class World {
     ...
     */
    getDimension(dimensionId: "overworld" | "nether" | "the end" | "the_end" | "minecraft:overworld" | "minecraft:nether" | "minecraft:the_end"): Dimension;
    /**
     * @beta
     * @remarks
     * Returns a property value.
...
/** List of Entity.getComponent method endpoints */
...
/** List of Block.getComponent method endpoints */
...
/** List of ItemStack.getComponent method endpoints */
